...
export const metadata: Metadata = {
  title: "Evenementen fotograaf en videograaf in Barendrecht | Second Shot Media",
  description: "Op zoek naar een evenementen fotograaf en videograaf in Barendrecht? Professionele fotografie en videografie voor congressen, bedrijfsfeesten en festivals in Barendrecht.",
};
...
export default async function Page() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <Hero
        title="Evenementen fotograaf en videograaf in Barendrecht"
