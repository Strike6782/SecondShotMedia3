...
export const metadata: Metadata = {
  title: "Evenementen fotograaf en videograaf in Doorn | Second Shot Media",
  description: "Op zoek naar een evenementen fotograaf en videograaf in Doorn? Professionele fotografie en videografie voor congressen, bedrijfsfeesten en festivals in Doorn.",
};
...
export default async function Page() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <Hero
        title="Evenementen fotograaf en videograaf in Doorn"
