...
export const metadata: Metadata = {
  title: "Evenementen fotograaf en videograaf in Driebergen-Rijsenburg | Second Shot Media",
  description: "Op zoek naar een evenementen fotograaf en videograaf in Driebergen-Rijsenburg? Professionele fotografie en videografie voor congressen, bedrijfsfeesten en festivals in Driebergen-Rijsenburg.",
};
...
export default async function Page() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <Hero
        title="Evenementen fotograaf en videograaf in Driebergen-Rijsenburg"
