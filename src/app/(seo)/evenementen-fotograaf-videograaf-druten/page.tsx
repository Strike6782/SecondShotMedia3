...
export const metadata: Metadata = {
  title: "Evenementen fotograaf en videograaf in Druten | Second Shot Media",
  description: "Op zoek naar een evenementen fotograaf en videograaf in Druten? Professionele fotografie en videografie voor congressen, bedrijfsfeesten en festivals in Druten.",
};
...
export default async function Page() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <Hero
        title="Evenementen fotograaf en videograaf in Druten"
