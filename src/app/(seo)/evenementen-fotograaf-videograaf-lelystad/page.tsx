...
export const metadata: Metadata = {
  title: "Fotograaf en videograaf voor evenementen en leisure in Lelystad | Second Shot Media",
  description: "Op zoek naar een fotograaf en videograaf voor evenementen en leisure in Lelystad? Professionele fotografie en videografie voor congressen, bedrijfsfeesten, festivals en leisure in Lelystad.",
};
...
export default async function Page() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <Hero
        title="Fotograaf en videograaf voor evenementen en leisure in Lelystad"
        subtitle="Professionele fotografie en videografie voor evenementen in Lelystad. Van congressen tot festivals."
        align="center"
      ...
      <section className="container py-12 px-4 max-w-screen-2xl space-y-16">
        <div>
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-2xl font-bold">Evenementen in Lelystad</h2>
