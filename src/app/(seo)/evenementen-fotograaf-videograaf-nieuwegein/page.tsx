...
export const metadata: Metadata = {
  title: "Evenementen fotograaf en videograaf in Nieuwegein | Second Shot Media",
  description: "Op zoek naar een evenementen fotograaf en videograaf in Nieuwegein? Professionele fotografie en videografie voor congressen, bedrijfsfeesten en festivals in Nieuwegein.",
};
...
export default async function Page() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <Hero
        title="Evenementen fotograaf en videograaf in Nieuwegein"
