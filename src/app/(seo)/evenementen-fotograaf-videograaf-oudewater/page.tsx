...
export const metadata: Metadata = {
  title: "Fotograaf en videograaf voor evenementen en leisure in Oudewater | Second Shot Media",
  description: "Op zoek naar een fotograaf en videograaf voor evenementen en leisure in Oudewater? Professionele fotografie en videografie voor congressen, bedrijfsfeesten, festivals en leisure in Oudewater.",
};
...
export default async function Page() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <Hero
        title="Fotograaf en videograaf voor evenementen en leisure in Oudewater"
        subtitle="Professionele fotografie en videografie voor evenementen in Oudewater. Van congressen tot festivals."
        align="center"
