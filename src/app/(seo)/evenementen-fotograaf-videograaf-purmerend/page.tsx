...
export const metadata: Metadata = {
  title: "Evenementen fotograaf en videograaf in Purmerend | Second Shot Media",
  description: "Op zoek naar een evenementen fotograaf en videograaf in Purmerend? Professionele fotografie en videografie voor congressen, bedrijfsfeesten en festivals in Purmerend.",
};
...
export default async function Page() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <Hero
        title="Evenementen fotograaf en videograaf in Purmerend"
