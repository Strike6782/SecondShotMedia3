...
export const metadata: Metadata = {
  title: "Evenementen fotograaf en videograaf in Utrecht | Second Shot Media",
  description: "Op zoek naar een evenementen fotograaf en videograaf in Utrecht? Professionele fotografie en videografie voor Jaarbeurs congressen, bedrijfsfeesten en festivals in Utrecht.",
};
