...
export const metadata: Metadata = {
  ...
  description: "Op zoek naar een evenementen fotograaf en videograaf in Utrecht? Professionele fotografie en videografie voor congressen, bedrijfsfeesten en festivals in Utrecht.",
};
