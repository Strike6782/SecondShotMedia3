...
export const metadata = buildPageMetadata({
  ...
  description:
    "Algemene voorwaarden van Second Shot Media. Lees hier onze afspraken over dienstverlening, betaling, levering en rechten.",
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="container py-16 px-6 md:px-12 max-w-4xl mx-auto">
        <div className="prose prose-lg dark:prose-invert max-w-none space-y-8">
          <div>
            <h2 className="text-xl font-bold mb-2">1. Definities</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-bold mb-2">2. Toepasselijkheid</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-bold mb-2">3. Offertes en Overeenkomst</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-bold mb-2">4. Betaling</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-bold mb-2">5. Annulering en Wijziging</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-bold mb-2">6. Levering</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-bold mb-2">7. Intellectueel Eigendom</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-bold mb-2">8. Aansprakelijkheid</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-bold mb-2">9. Klachten</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-bold mb-2">10. Overmacht</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-bold mb-2">11. Toepasselijk Recht</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-bold mb-2">12. Privacy en Gegevensbescherming</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-bold mb-2">13. Revisies en Aanpassingen</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-bold mb-2">14. Overige Bepalingen</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-bold mb-2">15. Slotbepalingen</h2>
            <p>
