...
// Homepage metadata: merkzin en zoektermen voor foto, video en leisure
export const metadata: Metadata = {
  title: "Fotograaf en videograaf voor evenementen en leisure | Midden-Nederland",
  description:
    "Fotografie en videografie voor evenementen, zakelijk en leisure. Aftermovies, eventreportages en social content voor attractieparken. Second Shot Media, Midden-Nederland.",
};
...
export default async function Home() {
  ...
  const leisureSpotlight = themeParkImages[0];

  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero: rustige achtergrond, merk + kernaanbod */}
      <section className="relative flex min-h-[50vh] flex-col items-center justify-center overflow-hidden bg-zinc-950 text-white px-4 py-16 text-center">
        ...
        <div className="relative z-10 max-w-4xl space-y-6">
          ...
          <p className="mx-auto max-w-2xl text-lg text-zinc-300 sm:text-2xl font-light">
            Fotograaf en videograaf voor evenementen en leisure in Midden-Nederland.
          </p>
      ...
      {/* Intro: wie je bent en waarin je video expliciet noemt */}
          ...
          <div className="space-y-6">
            ...
            <div className="prose dark:prose-invert text-muted-foreground text-lg space-y-6">
              <p>
                ...
                Ik ben gespecialiseerd in het vastleggen van de energie en sfeer van evenementen door heel Midden-Nederland, en het leveren van video's en social
                content voor attractieparken en leisure bestemmingen.
              </p>
              <p>
              Of u nu op zoek bent naar een evenementen fotograaf voor uw festival of bedrijfsfeest, of een professionele aftermovie laat maken: ik lever beelden die impact maken.
      ...
      {/* Diensten: video en leisure eerst; club en studenten lager */}
        ...
        <div className="container max-w-screen-xl space-y-12">
          <div className="text-center max-w-2xl mx-auto space-y-4">
            ...
            <p className="text-muted-foreground text-lg">
              Foto en video voor events, zakelijk en leisure — per project het juiste middel.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <ServiceCard
              ...
              description="Aftermovies, showreels en sfeerimpressies. Bewegend beeld dat past bij jouw merk."
      ...
      {/* Leisure-videografie: eigen blok met CTA naar social-content-leisure */}
      <section className="container py-16 md:py-20 px-4 max-w-screen-xl">
        <div className="grid md:grid-cols-2 gap-10 md:gap-14 items-center rounded-2xl border bg-muted/20 p-8 md:p-12">
          <div className="space-y-5">
            <h2 className="text-2xl md:text-3xl font-bold text-foreground">Videografie voor leisure</h2>
            <p className="text-muted-foreground text-lg leading-relaxed">
              Voor attractieparken, dagjes uit en andere leisuremerken maak ik samen met een klein team korte video&apos;s en social content die passen bij jouw doelgroep.
              Denk aan leuke tiktoks en reels die de sfeer van jouw park of beleving naar je volgers brengen.
            </p>
            <Button size="lg" asChild>
              <Link href="/social-content-leisure/" prefetch={false}>
                Naar leisure &amp; social content
              </Link>
            </Button>
          </div>
          {leisureSpotlight ? (
            <Link
              href="/social-content-leisure/"
              prefetch={false}
              className="relative aspect-video w-full overflow-hidden rounded-xl bg-muted ring-offset-background transition-opacity hover:opacity-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
            >
              <Image
                src={leisureSpotlight.src}
                alt={leisureSpotlight.alt}
                width={leisureSpotlight.width}
                height={leisureSpotlight.height}
      ...
      <section className="container py-16 md:py-24 px-4 max-w-screen-xl">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="relative aspect-square md:aspect-auto md:h-[500px] rounded-2xl overflow-hidden bg-muted order-last md:order-first">
            <div className="absolute inset-0">
              <Image
                src="/images/Ivan-Secondshotmedia-uitweek.jpg"
                alt="Ivan Balkenende"
                fill
                className="object-cover"
              />
          ...
          <div className="space-y-6">
            <h2 className="text-3xl font-bold text-foreground">Het gezicht achter de camera</h2>
            <div className="prose dark:prose-invert text-muted-foreground text-lg space-y-6">
              <p>
              Hoi! Ik ben Ivan, evenementen fotograaf en videograaf uit Utrecht. Ik ben iemand met veel te veel hobbies. De meeste vallen af na enkele maanden, maar fotografie en videografie is iets wat is blijven hangen, en wat ik tegenwoordig mijn werk mag noemen. Over de jaren heen heb ik in meerdere mediateams van grote evenementen gezeten tot wel 50.000 bezoekers, ben ik als freelancer in te huren, en run ik een klein team om social media content te maken voor attractieparken en andere dagattracties.
              </p>
              <p>
                Dit alles doe ik naast mijn studie informatica aan de Universiteit Utrecht, iets wat ideaal combineerbaar is met elkaar. Naast foto- en videografie doe ik ook nog websiteontwikkeling.
      ...
      >
        <div className="text-center max-w-2xl mx-auto space-y-4">
          ...
          <p className="text-muted-foreground text-lg">
            Foto-impressies per categorie. Voor mijn video portfolio, zie de{" "}
            <Link href="/videografie/" className="text-primary underline-offset-4 hover:underline" prefetch={false}>
              videografie-pagina
            </Link>{" "}
          </p>
        </div>
        ...
        <div className="space-y-12">
          ...
          <div>
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-2xl font-bold">Attractieparken &amp; leisure</h3>
              <Button variant="ghost" asChild>
                <Link href="/social-content-leisure/" prefetch={false}>
                  Bekijk meer &rarr;
                </Link>
      ...
      {/* Afsluitende CTA: breder dan alleen &apos;event&apos; */}
      <section className="py-24 px-4 container max-w-screen-md mx-auto text-center space-y-8">
        ...
        <p className="text-muted-foreground text-lg">
          Of het nu om een event, zakelijke productie of leisure-content gaat: vraag een vrijblijvende offerte aan.
...
// Klikbare diensttegel met hover-state
