...
export const metadata: Metadata = {
  title: "Portfolio | Second Shot Media",
  description: "Bekijk het portfolio van Second Shot Media. Evenementenfotografie van festivals, clubs, gala's en zakelijke events.",
};

export default async function PortfolioPage() {
  // Combine images from different directories effectively
  // Functionally, it might be better to show categories here linking to service pages, 
  // or a mixed "Best Of" gallery. For now, let's load 'events' and 'club' as examples.
  ...
  // Mix them or show in sections. Sections is cleaner.

  return (
    <div className="flex flex-col min-h-screen">
      <Hero
        title="Algemeen Portfolio"
        subtitle="Een selectie van mijn werk."
        align="center"
