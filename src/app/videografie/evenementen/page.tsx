...
export const metadata: Metadata = {
  ...
  description:
    "Professionele aftermovies en evenementenregistratie in Midden-Nederland. Laat uw festival, feest of congres vastleggen door Second Shot Media.",
};

export default async function EventVideographySubPage() {
